      ...
      <ScrollReveal>
        <section className="py-24 px-6 md:px-16 bg-[var(--color-brand-pink-light)] text-center relative overflow-hidden">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Fully readable serif quote */}
            <h2 className="font-heading italic text-2xl md:text-3xl lg:text-4xl text-[var(--color-brand-black)] mb-12 leading-relaxed max-w-3xl mx-auto font-medium">
